...
public class lifeEventStr {
    ...
    String lifeEventAge3;
    String requiredFunds3;
    String lifeEventAge4;
    String requiredFunds4;
    ...
    public lifeEventStr(String lifeEventAge1, String requiredFunds1, String lifeEventAge2, String requiredFunds2, String lifeEventAge3, String requiredFunds3, String lifeEventAge4, String requiredFunds4, String lifeEventAge5, String requiredFunds5) {
        ...
        this.requiredFunds2 = requiredFunds2;
        this.lifeEventAge3 = lifeEventAge3;
        this.requiredFunds3 = requiredFunds3;
        this.lifeEventAge4 = lifeEventAge4;
        this.requiredFunds4 = requiredFunds4;
        this.lifeEventAge5 = lifeEventAge5;
        this.requiredFunds5 = requiredFunds5;
    }
}
